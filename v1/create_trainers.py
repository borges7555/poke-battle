...
def create_TrainedPokemon(pokemon: list, current_stats: list, move1: str, move2: str, move3: str, move4: str) -> TrainedPokemon:
    return [pokemon, current_stats, move1, move2, move3, move4]
